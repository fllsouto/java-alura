		...
		<div class="clearfix container">
			...
			<div id="header-content">
				<nav id="main-nav">
					...
					<ul class="clearfix">
						<li><a href="${s:mvcUrl('PC#listar').build()}" rel="nofollow">Cadastro
								de Produtos</a></li>
						<li><a href="${s:mvcUrl('PC#form').build()}" rel="nofollow">Listagem
								de Produtos</a></li>
	...
	<section id="index-section" class="container middle">
		...
		<ul class="clearfix book-collection">
			...
			<c:forEach items="${produtos}" var="produto">
				...
				<li><a
					href="${s:mvcUrl('PC#detalheId').arg(0, produto.id).build() }"
